          ...
          <>
            <section className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 mb-8">
              <div className="flex gap-4">
                <input
                  className="flex-1 text-xl px-4 py-3 rounded-xl border border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 outline-none transition-all"
                ...
                />
                <button 
                  className="px-8 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold hover:shadow-lg hover:scale-105 transition-all disabled:opacity-50 disabled:hover:scale-100"
                  onClick={onGenerate}
                  disabled={isLoading}
                >
            ...
            <div className="flex items-end gap-4 mb-4">
              <div className="font-bold text-gray-700">Add Prompts:</div>
...
function Editor({ data, onClose }){
  ...
  // New: Draggable positions (0-1 normalized)
  ...
  return (
    <div className="flex gap-8">
      ...
      <aside className="w-96 bg-white rounded-xl shadow-lg border border-gray-200 p-6 h-fit sticky top-6">
        ...
        <div className="mt-6 pt-6 border-t border-gray-200">
          <button 
            className="w-full px-6 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold hover:shadow-lg hover:scale-105 transition-all"
            onClick={downloadPNG}
          >
          ...
          <p className="text-xs text-gray-500 text-center mt-3">
            💡 Drag the purple (T) and blue (A) handles to reposition text
          </p>
        </div>
      </aside>
    </div>
